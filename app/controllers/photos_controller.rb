class PhotosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @photo.update(photo_params)
        format.html { redirect_to [@photo.album, @photo], notice: 'Photo was successfully updated.' }
  ...
  def destroy
    @photo.destroy
    respond_to do |format|
      format.html { redirect_to album_photos_url(@photo.album), notice: 'Photo was successfully destroyed.' }
  ...
  private
    ...
    def photo_params
      params.require(:photo).permit(:title, :description, :album_id, :capture_time, :longitude, :latitude, :use_as_cover)
    end
end
